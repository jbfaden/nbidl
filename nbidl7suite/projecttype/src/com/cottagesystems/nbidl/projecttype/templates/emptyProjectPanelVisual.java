...
public class emptyProjectPanelVisual extends JPanel implements DocumentListener {
    
    public static final String PROP_PROJECT_NAME = "projectName";
    
    private emptyProjectWizardPanel panel;
    
    /** Creates new form PanelProjectLocationVisual */
    public emptyProjectPanelVisual(emptyProjectWizardPanel panel) {
        initComponents();
        this.panel = panel;
