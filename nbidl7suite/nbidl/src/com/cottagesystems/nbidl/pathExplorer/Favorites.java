...
import com.cottagesystems.nbidl.pathExplorer.Exceptions;
...
final class Favorites extends FilterNode {
    ...
    public Image getIcon (int type) {
        return Utilities.loadImage("com/cottagesystems/nbidl/pathExplorer/resources/actionSelect.gif"); // NOI18N
    }
    ...
    public Action[] getActions(boolean context) {
        return new Action[] {Actions.addOnPathExplorerNode(), Actions.rescan(), Actions.startSession()};
    }
