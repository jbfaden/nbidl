...
final class IOEvent extends AWTEvent implements ActiveEvent {
    ...
    static final int CMD_SET_PROMPT=12;
     ...
     */
    IOEvent(PvwaveIO source, int command, boolean value) {
     ...
     */
    IOEvent(PvwaveIO source, int command, Object data) {
    ...
    public PvwaveIO getIO() {
        return getSource() instanceof PvwaveIO ? (PvwaveIO) getSource() : null;
    }
