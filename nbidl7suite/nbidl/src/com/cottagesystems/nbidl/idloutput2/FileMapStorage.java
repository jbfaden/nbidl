...
class FileMapStorage implements Storage {
    ...
    public synchronized void dispose() {
        if (PvwaveController.log) {
            PvwaveController.log ("Disposing file map storage");
    ...
    public void flush() throws IOException {
        if (buffer != null) {
            if (PvwaveController.log) PvwaveController.log("FILEMAP STORAGE flush(): " + outstandingBufferCount);
            write (buffer, false);
    ...
    public void close() throws IOException {
        if (writeChannel != null) {
            ...
            writeChannel.close();
            writeChannel = null;
            if (PvwaveController.log) PvwaveController.log("FILEMAP STORAGE CLOSE.  Outstanding buffer count: " + outstandingBufferCount);
        }
    }
