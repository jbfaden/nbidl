...
public class BreakpointsReader implements Properties.Reader {
    ...
    public String [] getSupportedClassNames () {
        return new String[] {
            PvwaveBreakpoint.class.getName (), 
        };
    }
    
    public Object read (String typeID, Properties properties) {
        if (!(typeID.equals (PvwaveBreakpoint.class.getName ())))
            return null;
        ...
        return PvwaveBreakpoint.create(line);
    }
    
    public void write (Object object, Properties properties) {
        PvwaveBreakpoint b = (PvwaveBreakpoint) object;
        FileObject fo = (FileObject) b.getLine ().getLineObject().getLookup ().
            lookup (FileObject.class);
        try {
            properties.setString ("url", fo.getURL ().toString ());
            properties.setInt (
                "lineNumber", 
                b.getLine ().getLineObject().getLineNumber ()
            );
